...
function Shell() {
  ...
  const [minesweeperLaunch, setMinesweeperLaunch] = useState<{ difficulty: Difficulty; key: number }>({ difficulty: 'Beginner', key: 0 });
  ...
  useEffect(() => listenForMinesweeperRequest((difficulty) => setMinesweeperLaunch((current) => ({ difficulty, key: current.key + 1 }))), []);
  return (
